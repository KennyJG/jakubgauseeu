<template>
    <div class="h-full py-6 mx-3">
        <div>
            <div v-if="menu.items.length == 0" class="mt-3 mb-3 text-gray-800 text-center">
                ...
                <div class="mb-6">
                    <div class="flex flex-col w-full relative">
                        <div class="w-3/4 mx-auto border-gray-800 ">
                            <div>
                                <div @click="selectMenuItem(item.id); highlightSelected('MenuItem-' + item.id)" v-for="(item, key) in menu.items" :class="{'mt-3': key !== 0}" class="px-3 py-2 border border-gray-400 flex justify-center items-center cursor-pointer hover:bg-gray-200 relative">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['menu', 'page', 'currentPageId']),
        },

        methods: {
            ...mapActions(['getRenderedHtml', 'refetchContent', 'unsetAll', 'highlightSelected', 'selectMenuItem']),
