<template>
    <div class="h-full py-6 mx-3">
        <div>
            <div v-if="page.sections.length == 0" class="mt-3 mb-3 text-gray-800 text-center">
                <div @click="createSection()" class="cursor-pointer">
                    ...
                    <div class="mb-6 text-gray-500">+ Přidat sekci</div>
                </div>
            </div>
            <div v-else>
                ...
                <div class="mb-6">
                    <div class="flex flex-col w-full relative">
                        <div class="border-r border-l border-b w-3/4 mx-auto border-gray-800 ">
                            <div @click="setLayout(section.id); highlightSelected('Layout-' + section.id)" v-for="section in page.sections" class="border-t border-gray-800 bg-gray-300 hover:bg-gray-300 cursor-pointer relative h-12">
                                <div class="absolute top-0 right-0 -mr-2 -mt-2 h-6 w-6 rounded-full hover:bg-gray-100 shadow-md flex justify-center items-center hover:text-red-500 text-gray-100 bg-red-500 cursor-pointer">
                                    <svg @click.stop="deleteSection(section.id)" class="fill-current inline-block h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
export default {
    ...
    computed: {
        ...mapGetters(['page', 'layout', 'currentPageId']),
    },
